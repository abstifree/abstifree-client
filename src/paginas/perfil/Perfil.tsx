...
import { Basket, CaretLeft, Pencil, ImageBroken, PencilSimpleLine, Trash, UserPlus } from '@phosphor-icons/react'
...
function EditarUsuario() {
  ...
  async function atualizarUsuario(e: ChangeEvent<HTMLFormElement>) {
    ...
    if (confirmarSenha === novoUsuario.senha &&
      senhaValida &&
      (novoUsuario.tipo === 'consumidor' || novoUsuario.tipo === 'administrador')) {
    ...
    switch (false) {
      ...
      case senhaValida:
        ...
        break
      case usuario.tipo === 'consumidor' || usuario.tipo === 'administrador':
        toast.info('Informe se você é um consumidor ou administrador')
        break
    }
  }
    ...
    <div className="w-full max-w-5xl items-center flex flex-col pt-8 pb-16 px-16 mx-auto">
      ...
      <form className="h-full w-full flex flex-col p-4" onSubmit={atualizarUsuario}>
        ...
        <div className="flex justify-around my-4">
          ...
          <div className={`${novoUsuario.tipo === 'administrador' ? 'text-orange-600 dark:text-orange-400' : ''} duration-300`}>
            <input
              id="administrador"
              type="radio"
              name="tipo"
